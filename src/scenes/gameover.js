/* eslint-disable  import/no-cycle, no-unused-vars, padded-blocks  */
...
class gameOver extends Phaser.Scene {
  ...
  async create() {
    ...
    this.add.text((gameOptions.widthWindow / 4) * 0.5, (gameOptions.heightWindow / 4) * 1 - 80, 'GameOver', { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize: '130px', color: '#7801F8' });
    this.add.text((gameOptions.widthWindow / 4) * 0.75, (gameOptions.heightWindow / 4) * 2 - 120, `Your Score: ${gameOptions.points}`, { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize: '70px', color: '#7801F8' });
