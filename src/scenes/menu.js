...
export default class titleScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text((gameOptions.widthWindow / 4) * 0.75, (gameOptions.heightWindow / 4) * 1 - 80, 'Ninja', { fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontSize: '150px', color: '#7801F8' });
    ...
    const logoImg = this.add.image((gameOptions.widthWindow / 4) * 1.1, (gameOptions.heightWindow / 4) * 3 - 140, 'ninjalogo');
    logoImg.setScale(0.5);
    playbttn.setScale(0.75);
